...
a persistence unit "examenFerreteriaPersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "examenFerreteria\pom.xml":
...
artifact ("examenFerreteria.war") is already built. You can build
